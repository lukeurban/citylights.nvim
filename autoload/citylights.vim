...
let g:citylights_terminal_italic = get(g:, 'citylights_terminal_italic', 0)
let s:italic = ""

if g:citylights_terminal_italic == 1
  let s:italic = "italic"
endif
" }}}
" {{{ Bold
let g:citylights_terminal_bold = get(g:, 'citylights_terminal_bold', 0)
let s:bold = ""
if g:citylights_terminal_bold == 1
 let s:bold = "bold"
endif
...
function! citylights#highlight( base00, base01, base02, base03, base04, base05, base06, base07, red, orange, yellow, green, cyan, blue, purple, brown, white, dark_green, none) abort
  ...
  call s:hi('IndentBlanklineSpaceCharBlankline', a:base01, '',       'nocombine', '')
    ...
    call s:hi('@lsp.type.decorator',                          a:cyan, '',       '',          '')
